...
__all__ = [
    'ISpProperties', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SVF_Stressed', 'DISPID_SASCurrentDevicePosition',
    'SPSERIALIZEDRESULT', 'DISPID_SOTGetDescription',
    'SPEI_RESERVED1', 'ISpDataKey', 'SpMMAudioEnum', 'SVPNormal',
    'SpeechPropertyComplexResponseSpeed', 'SAFTCCITT_ALaw_8kHzMono',
    'UINT_PTR', 'DISPID_SLGetGenerationChange', 'SPAS_STOP',
    'SVEPrivate', 'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SOTGetAttribute',
    'DISPID_SRState', 'DISPID_SGRsCommitAndSave', 'SREInterference',
    'SRADefaultToActive', 'SpeechEngineProperties', 'SRTReSent',
    'SAFT44kHz16BitStereo', 'DISPID_SAFGetWaveFormatEx',
    'SAFT11kHz16BitStereo', 'SGRSTTWildcard', 'DISPID_SVGetVoices',
    'ISequentialStream', 'SpeechPropertyResourceUsage', 'SPSModifier',
    'SPCT_DICTATION', 'DISPID_SVSVisemeId', 'SPEI_TTS_PRIVATE',
    'DISPID_SVWaitUntilDone', 'SPLO_DYNAMIC', 'ISpeechFileStream',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRGetPropertyString',
    'DISPIDSPRG', 'DISPID_SRCRetainedAudioFormat', 'SDTReplacement',
    'SAFTGSM610_44kHzMono', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SPARecoResult',
    'DISPID_SASetState', 'ISpRecoGrammar', 'SINone', 'SPEI_RESERVED6',
    'SPRST_INACTIVE', 'SGDSActive', 'SPPS_RESERVED1',
    'SAFTCCITT_ALaw_8kHzStereo', 'SWTDeleted',
    'DISPID_SRGCmdSetRuleIdState', 'SDA_Two_Trailing_Spaces',
    'SpeechRuleState', 'SVP_17', 'SpeechWordPronounceable',
    'SRSEDone', 'DISPID_SRRSaveToMemory', 'ISpSerializeState',
    'SAFT8kHz8BitStereo', 'ISpeechPhraseReplacement',
    'SECFIgnoreCase', 'SPDATAKEYLOCATION', 'SP_VISEME_4',
    'eLEXTYPE_RESERVED4', 'SAFT44kHz16BitMono', 'SP_VISEME_0',
    'DISPID_SLGetWords', 'SpeechWordType',
    'SpeechGrammarTagDictation', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SLWs_NewEnum', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SVSkip', 'SP_VISEME_3', 'ISpeechAudioBufferInfo',
    'DISPID_SVEAudioLevel', 'ISpeechLexicon',
    'DISPID_SPEAudioTimeOffset', 'SpPhoneticAlphabetConverter',
    'DISPID_SLPPhoneIds', 'DISPID_SRAudioInputStream', 'SPBO_PAUSE',
    'DISPID_SGRSTText', 'SVEEndInputStream', 'SpLexicon',
    'ISpeechRecoResult', 'SVSFUnusedFlags',
    'SpeechPropertyHighConfidenceThreshold', 'SRAORetainAudio',
    'DISPID_SRCEHypothesis', 'SPPS_Interjection',
    'SAFTNoAssignedFormat', 'ISpAudio', 'ISpObjectToken',
    'DISPID_SWFEAvgBytesPerSec', 'STSF_AppData', 'SP_VISEME_5',
    'DISPID_SABufferInfo', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SP_VISEME_11', 'SpeechRecognitionType',
    'DISPID_SRSSupportedLanguages', 'SINoSignal',
    'DISPID_SWFEBitsPerSample', 'ISpRecoResult',
    'DISPID_SDKGetBinaryValue', 'SITooQuiet',
    'DISPID_SRCSetAdaptationData', 'DISPID_SGRId',
    'IInternetSecurityManager', 'SVP_2', 'eLEXTYPE_PRIVATE19',
    'SRAInterpreter', 'SVP_3', 'DISPID_SBSWrite',
    'ISpeechMemoryStream', 'SAFT11kHz8BitMono',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SpeechRecoResult',
    'DISPID_SRCEBookmark', 'SAFTTrueSpeech_8kHz1BitMono',
    'SVEAudioLevel', 'SpPhoneConverter',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVGetProfiles', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SGRSTTRule', 'SPGRAMMARWORDTYPE',
    'DISPID_SRCERecognitionForOtherContext', 'ISpeechAudioStatus',
    'DISPID_SRCCmdMaxAlternates', 'SpeechAddRemoveWord',
    'SPINTERFERENCE_TOOSLOW', 'SpeechDictationTopicSpelling',
    'DISPID_SPRFirstElement', 'SRTExtendableParse', 'SPVPRI_OVER',
    'DISPID_SRRGetXMLErrorInfo', 'SPRECOCONTEXTSTATUS', 'SVP_6',
    'DISPID_SRGetPropertyNumber', 'SPPS_RESERVED2', 'DISPIDSPTSI',
    'SSSPTRelativeToStart', 'SWPUnknownWordPronounceable', 'IStream',
    'SPRS_ACTIVE', 'SpeechPropertyNormalConfidenceThreshold',
    'SpeechDisplayAttributes', 'DISPID_SRRTOffsetFromStart',
    'SECNormalConfidence', 'SPPHRASEELEMENT',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SVEPhoneme',
    'DISPID_SRCESoundStart', 'DISPID_SVSLastStreamNumberQueued',
    'SpStream', 'DISPID_SRGetRecognizers', 'SPSHORTCUTTYPE',
    'DISPID_SPRuleConfidence', 'DISPID_SRSetPropertyNumber',
    'ISpStreamFormatConverter', 'DISPID_SpeechCustomStream',
    'SPWT_DISPLAY', 'DISPID_SLWLangId', 'SVP_12',
    'ISpeechResourceLoader', 'DISPID_SpeechRecoContextEvents',
    'SpeechLexiconType', 'DISPID_SRRecognizer', 'DISPID_SOTCategory',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpRecoCategory',
    'Speech_StreamPos_RealTime', 'SpeechAllElements',
    'DISPID_SPPConfidence', 'DISPID_SLPsItem',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpeechTokenKeyUI',
    'SGPronounciation', 'DISPID_SPELexicalForm',
    'SAFT8kHz16BitStereo', 'DISPID_SpeechObjectToken',
    'SDKLCurrentUser', 'SAFT12kHz16BitStereo', 'ISpLexicon',
    'ISpShortcut', 'DISPID_SPEs_NewEnum', 'SPEI_MIN_SR', 'SPWORDLIST',
    'SSFMCreate', 'DISPID_SOTCGetDataKey', 'DISPID_SOTCreateInstance',
    'tagSTATSTG', 'SAFT8kHz8BitMono', 'ISpPhoneticAlphabetConverter',
    'DISPID_SVEStreamEnd', 'SAFTADPCM_11kHzStereo',
    'DISPID_SRCEStartStream', 'SpeechRecoProfileProperties',
    'DISPID_SRSCurrentStreamPosition', 'SPINTERFERENCE_NONE',
    'ISpeechVoiceStatus', 'SREPropertyStringChange',
    'SDKLLocalMachine', 'SAFT32kHz16BitMono',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpeechVoice',
    'DISPID_SRCEInterference', 'SpeechRunState', 'SP_VISEME_18',
    'SPRECOGNIZERSTATUS', 'SRESoundStart', 'SAFTADPCM_8kHzStereo',
    'SPPS_SuppressWord', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SBSRead', 'STSF_LocalAppData', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRCESoundEnd', 'DISPID_SRGId',
    'DISPID_SRSetPropertyString', 'eLEXTYPE_PRIVATE1',
    'SAFTADPCM_11kHzMono', 'SDTDisplayText', 'SP_VISEME_10',
    'DISPID_SPERetainedSizeBytes', 'SSFMCreateForWrite', 'SVP_1',
    'SPAR_Unknown', 'DISPID_SPPName',
    'DISPID_SpeechPhraseReplacements', 'SpeechPartOfSpeech',
    'DISPID_SPRulesCount', 'DISPID_SLAddPronunciation', 'SAFTDefault',
    'DISPID_SBSFormat', 'ISpeechMMSysAudio',
    'DISPID_SVSLastBookmarkId', 'ISpResourceManager',
    'DISPID_SPRsItem', 'DISPID_SLRemovePronunciation',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPINTERFERENCE_TOOFAST',
    'SRSActive', 'SPEVENT', 'DISPID_SLWsCount',
    'SAFTADPCM_44kHzStereo', 'DISPIDSPTSI_ActiveLength',
    'SPEI_FALSE_RECOGNITION', 'SPLO_STATIC', 'SPVPRI_ALERT',
    'ISpMMSysAudio', 'SPWF_SRENGINE', 'SpeechVisemeType',
    'SAFTADPCM_44kHzMono', 'SPADAPTATIONRELEVANCE',
    'SRSInactiveWithPurge', 'DISPID_SPIAudioSizeBytes', 'SP_VISEME_2',
    'SpResourceManager', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SpeechAudioBufferInfo', 'SRSActiveAlways',
    ...
    'SpNullPhoneConverter', 'SPINTERFERENCE_LATENCY_WARNING',
    'eLEXTYPE_PRIVATE12', 'SAFT44kHz8BitMono', 'SPBINARYGRAMMAR',
    'SpeechMicTraining', 'DISPID_SRGSetTextSelection',
    'SpSharedRecognizer', 'SAFTCCITT_uLaw_22kHzMono', 'SASRun',
    'ISpeechPhraseRule', 'eLEXTYPE_PRIVATE18',
    ...
    'SAFT22kHz8BitMono', 'SAFT16kHz8BitStereo', 'ISpeechRecoResult2',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SGRsFindRule',
    'SpeechAudioProperties', 'ISpeechObjectTokens',
    'SWPKnownWordPronounceable', 'SVP_14',
    'ISpeechPhraseReplacements', 'SVP_16', 'SAFTGSM610_11kHzMono',
    'DISPID_SVSpeak', 'DISPID_SPIStartTime', 'DISPID_SGRAddResource',
    'SAFT8kHz16BitMono', 'SAFTNonStandardFormat', 'DISPID_SPPsCount',
    'SAFT48kHz16BitMono', 'SPEI_SR_PRIVATE', 'ISpeechRecoResultTimes',
    'ISpRecognizer2', 'DISPID_SASFreeBufferSpace', 'SP_VISEME_15',
    'DISPID_SDKSetLongValue', 'SECHighConfidence', 'SVP_5',
    'DISPID_SVEWord', 'DISPID_SRRTTickCount', 'DISPID_SMSALineId',
    'SVSFIsNotXML', 'SVSFParseAutodetect', 'SpeechVoicePriority',
    'STCInprocServer', 'DISPID_SOTRemoveStorageFileName',
    'SPEI_RECOGNITION', 'DISPID_SpeechPhraseProperties',
    'SAFTCCITT_uLaw_8kHzStereo', 'SRAONone', 'DISPID_SVResume',
    'DISPID_SPISaveToMemory', 'DISPID_SRDisplayUI', 'SECFIgnoreWidth',
    ...
    'SGDSActiveWithAutoPause', 'SPEI_SR_RETAINEDAUDIO',
    ...
    'DISPID_SRCEAudioLevel', 'DISPID_SRGState', 'DISPID_SPRuleId',
    'SPPS_RESERVED3', 'SVPAlert', 'DISPID_SRCResume',
    'ISpeechRecoGrammar', 'DISPID_SPAsItem', 'SVSFPurgeBeforeSpeak',
    'SP_VISEME_16', 'SAFT48kHz16BitStereo',
    'ISpeechLexiconPronunciations', 'SAFT24kHz16BitStereo',
    'DISPID_SVEBookmark', 'ISpeechBaseStream', 'SPPS_Noun',
    'DISPID_SRRGetXMLResult', 'Speech_StreamPos_Asap',
    'DISPID_SGRClear', 'ISpRecoGrammar2', 'SPEI_PROPERTY_NUM_CHANGE',
    'SP_VISEME_14', 'SLTUser', 'SPCS_ENABLED', 'DISPID_SDKOpenKey',
    'ISpeechGrammarRule', 'DISPID_SGRSTNextState',
    'DISPID_SpeechRecoContext', 'SAFT22kHz16BitMono',
    'ISpeechObjectToken', 'SSTTTextBuffer', 'SVP_4', 'SFTInput',
    'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SPIRetainedSizeBytes', 'DISPIDSPTSI_SelectionLength',
    'LONG_PTR', 'SPSEMANTICERRORINFO', 'DISPID_SPEPronunciation',
    'ISpeechDataKey', 'SpMemoryStream', 'DISPID_SGRSTPropertyId',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SpeechAudio',
    'SpeechAudioState', 'SPAR_Low', 'DISPID_SDKSetBinaryValue',
    'SVP_11', 'DISPID_SVSpeakStream', 'DISPID_SpeechPhraseBuilder',
    'eLEXTYPE_PRIVATE11', 'DISPID_SpeechRecognizer',
    'DISPID_SpeechPhraseReplacement', 'SpeechDiscardType',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SMSGetData',
    'DISPID_SLGetPronunciations', 'DISPID_SpeechPhraseRules',
    'DISPID_SOTCDefault', 'SPAS_RUN', 'DISPID_SRIsUISupported',
    'SREPhraseStart', 'SVSFParseSsml', 'DISPID_SDKGetlongValue',
    'DISPID_SABIMinNotification', 'DISPID_SOTCSetId',
    'SPINTERFERENCE_TOOQUIET', 'SpeechRecoEvents', 'SPEI_PHONEME',
    'SGRSTTWord', 'DISPID_SRGCommit', 'SGLexical',
    'IInternetSecurityMgrSite', 'ISpeechTextSelectionInformation',
    'DISPID_SLPsCount', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'ISpeechPhraseAlternate', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SVGetAudioInputs', 'SpeechAudioFormatGUIDWave',
    'DISPID_SpeechGrammarRule', 'SAFTCCITT_uLaw_11kHzMono',
    'eLEXTYPE_PRIVATE7', 'SPSFunction', 'SPCS_DISABLED',
    'ISpeechRecoResultDispatch', 'SPCT_COMMAND',
    'DISPID_SVAlertBoundary', 'SpeechCategoryPhoneConverters',
    'SpeechTokenIdUserLexicon', 'SREHypothesis', 'SGRSTTDictation',
    'SPRECOSTATE', 'DISPID_SPRuleNumberOfElements', 'SPEI_RESERVED5',
    'DISPID_SPEEngineConfidence', 'SPWAVEFORMATTYPE', 'SP_VISEME_17',
    'SpeechAudioFormatType', 'SDTProperty', 'SPEI_WORD_BOUNDARY',
    'DISPID_SpeechAudioFormat', 'SVF_None', 'DISPID_SGRSTType',
    'DISPID_SpeechRecoResult2', 'DISPID_SOTsItem',
    'eLEXTYPE_PRIVATE8', 'DISPID_SRCEPropertyNumberChange',
    'SPEI_VISEME', 'DISPID_SPRText', 'SPINTERFERENCE_TOOLOUD',
    'SPVISEMES', 'SPSHT_Unknown', 'SVP_15',
    'DISPID_SpeechPhraseElements', 'SITooLoud', 'DISPID_SGRName',
    'DISPID_SpeechPhraseInfo', 'DISPID_SGRsAdd', 'DISPID_SLPSymbolic',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPLEXICONTYPE',
    'SpTextSelectionInformation', 'SGSEnabled',
    'SpeechGrammarWordType', 'SVSFNLPSpeakPunc',
    'DISPID_SGRSAddRuleTransition', 'SpObjectTokenCategory',
    'SREAdaptation', 'DISPID_SGRSTsCount', 'SPEI_INTERFERENCE',
    'DISPID_SpeechObjectTokens', 'DISPID_SRRSpeakAudio',
    'DISPID_SVSPhonemeId', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SPCIdToPhone', 'DISPID_SRCEventInterests',
    'DISPID_SpeechGrammarRuleState', 'SPSMF_UPS', 'SPEVENTSOURCEINFO',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SpeechPhraseAlternate',
    'SITooFast', 'SAFTADPCM_22kHzMono', 'SPAUDIOSTATE',
    'DISPID_SWFESamplesPerSec', 'SpeechBookmarkOptions',
    'SpeechAudioFormatGUIDText', 'SPTEXTSELECTIONINFO',
    'DISPID_SLWWord', 'SPVPRIORITY', 'DISPID_SpeechLexicon',
    'DISPID_SLPType', 'SPCATEGORYTYPE', 'SVP_8',
    'ISpeechXMLRecoResult', 'SP_VISEME_13', 'ISpNotifyTranslator',
    'SpeechGrammarTagWildcard', 'DISPID_SPEActualConfidence',
    'WAVEFORMATEX', 'DISPID_SPRsCount', 'SpeechVoiceEvents',
    'DISPID_SRCBookmark', 'DISPID_SGRsCount', 'SPPARTOFSPEECH',
    'SINoise', 'SPPS_RESERVED4', 'DISPID_SRRDiscardResultInfo',
    'SAFT16kHz16BitStereo', 'eLEXTYPE_MORPHOLOGY', 'SPSHT_EMAIL',
    'SpMMAudioOut', 'SPEVENTENUM', 'SDA_One_Trailing_Space',
    'DISPID_SRSAudioStatus', 'DISPID_SRGDictationLoad',
    'DISPID_SPRulesItem', 'SPBOOKMARKOPTIONS',
    'Speech_Default_Weight', 'SPEI_MAX_TTS',
    'DISPID_SPRNumberOfElements', 'SpeechInterference', 'SPAR_High',
    'SREStreamEnd', 'ISpVoice', 'SAFT12kHz16BitMono',
    ...
    'ISpGrammarBuilder', 'DISPID_SPRs_NewEnum', 'ISpRecognizer',
    'ISpeechCustomStream', 'DISPID_SRCreateRecoContext',
    'ISpeechGrammarRuleStateTransition', 'SREAllEvents',
    'Speech_Max_Word_Length', 'DISPID_SWFEFormatTag',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SVSCurrentStreamNumber',
    'ISpeechLexiconWords', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPAS_PAUSE', 'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SBSSeek',
    'SREPropertyNumChange', 'eWORDTYPE_ADDED', 'SRSInactive',
    'SPFM_OPEN_READONLY', 'SPEI_ADAPTATION', 'SPEI_RESERVED2',
    'DISPID_SPEAudioSizeTime', 'SAFT12kHz8BitMono',
    'DISPID_SpeechVoice', 'DISPIDSPTSI_SelectionOffset',
    'SPSInterjection', 'SPPS_LMA', 'DISPID_SPEsItem', 'SPWORD',
    'SpShortcut', 'SAFTGSM610_8kHzMono', 'SVSFlagsAsync',
    'SPPS_Noncontent', 'DISPID_SPACommit', 'DISPID_SRCRecognizer',
    'DISPID_SPIEngineId', 'SGDSInactive', 'SAFT24kHz16BitMono',
    'SSSPTRelativeToEnd', 'SpeechRecognizerState',
    'DISPID_SPIGetDisplayAttributes', 'SPSVerb', 'STSF_CommonAppData',
    'SPEI_HYPOTHESIS', 'DISPID_SVAudioOutputStream',
    'DISPID_SRCCreateResultFromMemory', 'SPPS_Unknown',
    'SRTAutopause', 'DISPID_SpeechXMLRecoResult', 'DISPID_SPPParent',
    'SWPUnknownWordUnpronounceable', 'SPDKL_LocalMachine',
    'SAFT24kHz8BitStereo', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SpNotifyTranslator', 'SPFM_NUM_MODES',
    'SpeechStreamSeekPositionType', 'ISpNotifySource',
    'SpWaveFormatEx', 'SPGS_DISABLED', 'DISPID_SAFType',
    'DISPID_SLWPronunciations', 'SPEI_SR_AUDIO_LEVEL', 'SRATopLevel',
    'DISPID_SPRuleEngineConfidence', 'SAFTExtendedAudioFormat',
    'DISPID_SVSInputWordLength', 'SpVoice',
    'DISPID_SGRSTPropertyName', 'SpeechRegistryLocalMachineRoot',
    'SpeechTokenValueCLSID', 'DISPID_SVGetAudioOutputs',
    'SPVPRI_NORMAL', 'SpeechRecoContextState', 'ISpeechRecoContext',
    'SPEI_SOUND_START', 'SPGS_EXCLUSIVE', 'DISPID_SVVoice',
    'SVEVoiceChange', 'DISPID_SPIGrammarId',
    'DISPID_SpeechLexiconWords', 'DISPID_SpeechVoiceStatus',
    'SPFM_CREATE_ALWAYS', 'SVF_Emphasis', 'SREAudioLevel',
    'eLEXTYPE_APP', 'ISpPhraseAlt', 'DISPID_SRCERecognition',
    'SPEI_RECO_OTHER_CONTEXT', 'SpInprocRecognizer',
    'SAFTCCITT_ALaw_11kHzStereo', 'SP_VISEME_9',
    'SAFT22kHz16BitStereo', 'SP_VISEME_7',
    'DISPID_SPEAudioStreamOffset', 'SASPause', 'DISPID_SOTId',
    'DISPID_SDKGetStringValue', 'SAFT32kHz8BitStereo',
    'SpeechAudioVolume', 'ISpeechPhraseInfo', 'SGSDisabled',
    'DISPID_SRIsShared', 'SVSFParseSapi', 'SPSTREAMFORMATTYPE',
    'SPCT_SUB_DICTATION', 'STCInprocHandler', 'SRCS_Disabled',
    'ISpObjectTokenCategory', 'SVP_18', 'SPEI_SR_BOOKMARK',
    'DISPID_SRCEEndStream', 'DISPID_SVSyncronousSpeakTimeout',
    'eLEXTYPE_PRIVATE4', 'DISPID_SVSInputWordPosition', 'SRTStandard',
    'DISPID_SOTGetStorageFileName', 'DISPID_SpeechGrammarRules',
    'DISPID_SRCEPhraseStart', 'SRARoot', 'DISPID_SRCERequestUI',
    'DISPID_SLPs_NewEnum', 'DISPID_SRCEFalseRecognition',
    'DISPID_SGRSTransitions', 'SPINTERFERENCE_NOSIGNAL',
    'SVEWordBoundary', 'SPSMF_SAPI_PROPERTIES', 'DISPID_SMSAMMHandle',
    'DISPID_SRRRecoContext', 'SAFT32kHz8BitMono', 'SpMMAudioIn',
    'ISpPhoneticAlphabetSelection', 'DISPID_SVPause',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPIReplacements',
    'DISPID_SRSClsidEngine', 'SVSFParseMask',
    'eLEXTYPE_VENDORLEXICON', 'SpCustomStream', 'SPSNoun',
    'DISPID_SPANumberOfElementsInResult', 'SpeechGrammarState',
    'SpeechTokenKeyAttributes', 'DISPID_SRRAudioFormat',
    'eLEXTYPE_PRIVATE13', 'DISPID_SFSClose', 'SPSUnknown',
    'SAFT16kHz8BitMono', 'ISpeechObjectTokenCategory',
    'DISPID_SpeechLexiconWord',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SLPLangId',
    'SREPrivate', 'SPRST_INACTIVE_WITH_PURGE', 'SGSExclusive',
    'SRAExport', 'SPINTERFERENCE_NOISE',
    'DISPID_SpeechPhraseProperty', 'SREStreamStart',
    'DISPID_SGRAttributes', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPRECORESULTTIMES', 'DISPID_SGRSRule', 'DISPID_SVEStreamStart',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPPHRASERULE',
    'DISPID_SRGDictationUnload', 'SVP_10', 'SPFM_CREATE',
    'DISPID_SRGCmdLoadFromMemory', 'SAFTText', 'DISPID_SDKDeleteKey',
    'eLEXTYPE_PRIVATE6', 'DISPID_SPPFirstElement',
    'DISPID_SVSInputSentencePosition', 'SPSHT_OTHER', 'SP_VISEME_19',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SGRSAddWordTransition', 'SPAO_NONE',
    'DISPID_SRRTStreamTime', 'DISPID_SPPChildren', 'SPGS_ENABLED',
    'SRSEIsSpeaking', 'DISPID_SAStatus', 'SPEI_TTS_BOOKMARK',
    'DISPID_SPIProperties', 'DISPID_SRGetFormat', 'SITooSlow',
    'DISPID_SRGIsPronounceable', 'eLEXTYPE_PRIVATE9',
    'SpSharedRecoContext', 'SPAO_RETAIN_AUDIO', 'DISPID_SOTRemove',
    'eLEXTYPE_RESERVED9', 'SP_VISEME_12', 'SAFT48kHz8BitStereo',
    'SECLowConfidence', 'SRTSMLTimeout', 'SPAUDIOOPTIONS',
    'DISPID_SGRSTPropertyValue', 'SVP_0', 'SpeechCategoryRecognizers',
    'DISPID_SpeechVoiceEvent', 'SPAR_Medium', 'DISPID_SRRTLength',
    'DISPID_SpeechBaseStream', 'eLEXTYPE_RESERVED8',
    'DISPID_SGRsItem', 'SPEI_END_INPUT_STREAM', 'SAFTADPCM_8kHzMono',
    'eLEXTYPE_PRIVATE2', 'DISPID_SABIEventBias',
    'DISPID_SRCEAdaptation', 'SLOStatic', 'DISPID_SPRuleFirstElement',
    'SPRULE', 'DISPID_SLWType', 'SPAUDIOBUFFERINFO',
    'ISpStreamFormat', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SPAs_NewEnum', 'SLODynamic', 'SPSHORTCUTPAIRLIST',
    'SAFT24kHz8BitMono', 'SDTAudio', 'SVPOver',
    'DISPID_SpeechDataKey', 'SRAImport', 'SpeechCategoryRecoProfiles',
    'SPSLMA', 'SP_VISEME_6', 'DISPID_SGRsCommit', 'SVEViseme',
    'DISPID_SPIAudioSizeTime',
    'DISPID_SLRemovePronunciationByPhoneIds', '_ISpeechVoiceEvents',
    'SVP_21', 'eLEXTYPE_PRIVATE3', 'SRERecoOtherContext',
    'DISPID_SRSCurrentStreamNumber', '_ISpeechRecoContextEvents',
    'DISPID_SADefaultFormat', 'SpeechVoiceCategoryTTSRate',
    'SVESentenceBoundary', 'DISPID_SRCRetainedAudio',
    'DISPID_SRRAudio', 'SPEI_SOUND_END',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SVSLastResult',
    'DISPID_SDKDeleteValue', 'DISPID_SRGRules',
    'DISPID_SWFEExtraData', 'SVP_20', 'SpeechVoiceSkipTypeSentence',
    '_SPAUDIOSTATE', 'DISPID_SPRuleChildren', 'SPRS_INACTIVE',
    'SAFTCCITT_ALaw_11kHzMono', 'SGDisplay', 'SVP_13',
    'SpeechCategoryVoices', 'SpeechRuleAttributes', 'SDTAlternates',
    'DISPID_SVSRunningState', 'ISpeechPhraseAlternates',
    'ISpXMLRecoResult', 'SRTEmulated', 'SPSHT_NotOverriden',
    'DISPID_SGRSTs_NewEnum', 'SAFT11kHz16BitMono',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SGRSTsItem',
    'DISPID_SPEsCount', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRGCmdLoadFromObject', 'SpFileStream', 'SpAudioFormat',
    'SpeechRetainedAudioOptions', 'ISpRecognizer3', 'SPPS_Function',
    'DISPID_SPPBRestorePhraseFromMemory', 'SREFalseRecognition',
    'SFTSREngine', 'SECFNoSpecialChars', 'SpeechDataKeyLocation',
    'Speech_Max_Pron_Length', 'eLEXTYPE_PRIVATE20',
    'SGDSActiveUserDelimited',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPEI_MAX_SR',
    'SSTTDictation', 'DISPID_SpeechMemoryStream', 'SVP_9',
    'DISPID_SVVolume', 'ISpPhoneConverter', 'ISpeechLexiconWord',
    'DISPID_SPIEnginePrivateData',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SREmulateRecognition', 'SpUnCompressedLexicon',
    'DISPID_SPRDisplayAttributes', 'DISPID_SDKCreateKey',
    'SAFT32kHz16BitStereo', 'SSFMOpenReadWrite', 'SPCT_SUB_COMMAND',
    'SpObjectToken', 'SPDKL_CurrentConfig', 'ISpRecoContext2',
    'SPRULESTATE', 'DISPID_SOTCId', 'DISPID_SRRPhraseInfo',
    'DISPID_SPIElements', 'SVSFIsFilename', 'SPAUDIOSTATUS',
    'ISpeechAudio', 'SpCompressedLexicon', 'SSTTWildcard',
    'SpeechStreamFileMode', 'ISpEventSink', 'SPXRO_SML', 'SPBO_AHEAD',
    'ISpeechPhraseRules', 'ISpeechGrammarRuleStateTransitions',
    'SRESoundEnd', 'SDKLCurrentConfig', 'DISPID_SRGReset',
    'DISPID_SCSBaseStream', 'SPBO_NONE', 'SPEI_START_SR_STREAM',
    'SVSFVoiceMask', 'SAFT16kHz16BitMono', 'STCRemoteServer',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SpeechPropertyAdaptationOn',
    'DISPID_SRCVoicePurgeEvent', 'SVEPhoneme',
    'DISPID_SVSLastBookmark', 'SPSSuppressWord',
    'SPXRO_Alternates_SML', 'SPLOADOPTIONS', 'SPFM_OPEN_READWRITE',
    'DISPID_SpeechPhraseAlternates', 'SREStateChange',
    'DISPID_SABIBufferSize', 'SP_VISEME_1', 'eLEXTYPE_RESERVED10',
    'ISpEventSource', 'SP_VISEME_21', 'DISPID_SRStatus', 'SPPHRASE',
    'SPPROPERTYINFO', 'DISPID_SVEViseme', 'SECFDefault',
    'DISPID_SRProfile', 'eLEXTYPE_USER_SHORTCUT', 'STCAll',
    'SASClosed', 'DISPID_SPPNumberOfElements', 'SPWT_PRONUNCIATION',
    'eLEXTYPE_USER', '__MIDL_IWinTypes_0009', 'DISPID_SVStatus',
    'SECFEmulateResult', 'SpeechCategoryAudioOut', 'SPINTERFERENCE',
    'STSF_FlagCreate', 'DISPID_SPAStartElementInResult',
    'DISPID_SVAudioOutput', 'SPFILEMODE', 'SBONone',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SPIRule',
    'DISPID_SpeechFileStream', 'DISPID_SOTIsUISupported',
    'eLEXTYPE_PRIVATE14', 'SpPhraseInfoBuilder', 'ISpeechRecognizer',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SLGenerationId',
    'SpeechCategoryAudioIn', 'DISPID_SVESentenceBoundary',
    'DISPID_SGRSTWeight', 'SPSNotOverriden', 'SpeechTokenShellFolder',
    'SpeechCategoryAppLexicons', 'DISPID_SRGCmdSetRuleState',
    'SPEI_START_INPUT_STREAM', 'ISpStream', 'DISPID_SAFGuid',
    'SPEI_UNDEFINED', 'DISPID_SPILanguageId', 'SVSFNLPMask',
    'SPCONTEXTSTATE', 'SpeechLoadOption',
    'DISPID_SOTMatchesAttributes', 'SpeechRegistryUserRoot',
    'SPCT_SLEEP', 'SVEStartInputStream',
    'SpeechEmulationCompareFlags', 'DISPID_SPPsItem', 'SRADynamic',
    'eLEXTYPE_LETTERTOSOUND', 'SPEI_RECO_STATE_CHANGE',
    'SPEI_VOICE_CHANGE', 'SREBookmark', 'DISPID_SVEEnginePrivate',
    'SpeechTokenContext', 'eLEXTYPE_PRIVATE10',
    'ISpeechPhraseElement', 'SGRSTTEpsilon',
    'DISPID_SpeechPhraseRule', 'DISPID_SOTs_NewEnum',
    'DISPID_SOTDisplayUI', 'SPPS_NotOverriden',
    'DISPID_SPEDisplayText', 'SASStop', 'DISPID_SPPs_NewEnum',
    'DISPID_SPEDisplayAttributes', 'SDTPronunciation', 'SPRST_ACTIVE',
    'SRERequestUI', 'DISPID_SVIsUISupported', 'SPRST_NUM_STATES',
    'SVSFDefault', 'SpeechEngineConfidence',
    'SpeechPropertyLowConfidenceThreshold', 'SGLexicalNoSpecialChars',
    'ISpeechPhoneConverter', 'DISPID_SMSADeviceId',
    'eLEXTYPE_PRIVATE16', 'ISpeechGrammarRules',
    'DISPID_SGRInitialState', 'SPPS_Modifier', 'SPBO_TIME_UNITS',
    'DISPID_SVEventInterests',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPAPhraseInfo', 'SPEI_RESERVED3', 'SPSERIALIZEDPHRASE',
    'SRERecognition', 'SGRSTTTextBuffer', 'DISPID_SPCLangId',
    'eLEXTYPE_PRIVATE5', 'eWORDTYPE_DELETED', 'SP_VISEME_20',
    'SVP_19', 'DISPID_SWFEBlockAlign', 'ISpeechPhraseProperty',
    'DISPID_SRAudioInput', 'SPSEMANTICFORMAT', 'DISPID_SOTSetId',
    'eLEXTYPE_RESERVED7', 'DISPID_SRCVoice',
    'ISpeechRecognizerStatus', 'DISPID_SMSSetData', 'SDTAll',
    'DISPID_SPRuleName', 'SSFMOpenForRead', 'SDKLDefaultLocation',
    'SVSFIsXML', 'eLEXTYPE_PRIVATE15', 'DISPID_SRGRecoContext',
    'DISPID_SDKEnumValues', 'tagSPPROPERTYINFO', 'DISPID_SAVolume',
    'DISPID_SPPEngineConfidence', 'SpeechSpecialTransitionType',
    'DISPID_SASNonBlockingIO', 'DISPID_SASState', 'DISPID_SRCPause',
    'ISpeechPhraseProperties', 'IEnumString', 'DISPID_SAEventHandle',
    'SPPHRASEREPLACEMENT', 'SVEBookmark', 'DISPID_SGRsDynamic',
    'SPWORDPRONUNCIATION', 'DISPID_SFSOpen', 'eLEXTYPE_RESERVED6',
    'ISpPhrase', 'SAFT44kHz8BitStereo', 'STCLocalServer', 'SWTAdded',
    'SpeechFormatType', 'SpeechVisemeFeature',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SVSInputSentenceLength',
    'SPDKL_DefaultLocation', 'DISPID_SRCRequestedUIType',
    'SPVOICESTATUS', 'ISpeechLexiconPronunciation', 'DISPID_SPPId',
    'DISPID_SGRSTRule', 'SPXMLRESULTOPTIONS',
    'SDA_Consume_Leading_Spaces', 'SAFTCCITT_ALaw_44kHzStereo',
    'SAFT48kHz8BitMono', 'SAFT11kHz8BitStereo',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SWFEChannels',
    'SPWORDPRONOUNCEABLE', 'SPEI_MIN_TTS', 'SPPS_Verb',
    'ISpNotifySink', 'SRCS_Enabled', 'ISpeechWaveFormatEx',
    'SPDKL_CurrentUser', 'DISPID_SVEVoiceChange', 'SPWT_LEXICAL',
    'DISPID_SpeechMMSysAudio', 'ISpeechPhraseElements',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SVRate',
    'DISPID_SpeechPhraseElement', 'SPEI_END_SR_STREAM',
    'SpeechVoiceSpeakFlags', 'SVEAllEvents',
    'DISPID_SpeechPhoneConverter', 'ISpeechAudioFormat', 'SBOPause',
    'SAFTCCITT_ALaw_44kHzMono', 'SVSFPersistXML', 'SPGRAMMARSTATE',
    'SLTApp', 'SPPHRASEPROPERTY', 'IEnumSpObjectTokens',
    'ISpRecoContext', 'DISPID_SPRuleParent', 'DISPID_SDKEnumKeys',
    'DISPID_SPAsCount', 'DISPID_SPERequiredConfidence',
    'DISPID_SRGDictationSetState', 'DISPID_SRRTimes',
    'SPEI_PHRASE_START', 'DISPID_SVPriority',
    'DISPID_SLPPartOfSpeech', 'DISPID_SpeechRecognizerStatus',
    'SPWF_INPUT', 'DISPID_SLWsItem', 'SPAS_CLOSED', 'SPWORDTYPE',
    'DISPID_SVDisplayUI', 'SP_VISEME_8', 'DISPID_SGRAddState',
    'SPEI_REQUEST_UI', 'SpeechUserTraining', 'SVP_7', 'SDTRule',
    'ISpeechPhraseInfoBuilder', 'SpeechTokenKeyFiles',
    'DISPID_SPRules_NewEnum', 'DISPID_SDKSetStringValue',
    'SpStreamFormatConverter', 'SDTLexicalForm', 'SECFIgnoreKanaType'
]

_check_version('1.1.14', 1633527809.532731)
